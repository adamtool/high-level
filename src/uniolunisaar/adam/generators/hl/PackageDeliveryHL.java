...
public class PackageDeliveryHL {
     ...
     * @return
     */
    public static HLPetriGame generateEwithPool(int nb_drones, int nb_packages, boolean withPartition) {
...
//                partitions.put("OK_d" + i, i + 1);
                for (int j = 0; j < nb_packages; j++) {
                    ...
                    partitions.put("pool_d" + i + "xp" + j, nb_drones + j + 1);
                }
            }
...
//        net.createFlow(t, ok, dArc); // Variante A
        net.createFlow(err, t, new ArcExpression(new Variable("dX")));
        net.createFlow(t, err, new ArcExpression(new Variable("dX")));
...
//        
     ...
     * @return
     */
    public static HLPetriGame generateE(int nb_drones, int nb_packages, boolean withPartition) {
//        if (machines < 2 || orders < 1) {
//            throw new RuntimeException("less than 2 machines or 1 order does not make any sense!");
//        }
...
//        
     ...
     * @return
     */
    public static HLPetriGame generateC(int nb_drones, int nb_packages, boolean withPartition) {
//        if (machines < 2 || orders < 1) {
//            throw new RuntimeException("less than 2 machines or 1 order does not make any sense!");
//        }
...
//        
     ...
     * @return
     */
    public static HLPetriGame generateC2(int nb_drones, int nb_packages, boolean withPartition) {
//        if (machines < 2 || orders < 1) {
//            throw new RuntimeException("less than 2 machines or 1 order does not make any sense!");
//        }
